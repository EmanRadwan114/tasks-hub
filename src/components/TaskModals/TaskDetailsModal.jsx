...
function TaskDetailsModal() {
  ...
  const { data: selectedTask, isLoading: isTaskLoading } =
    useGetTaskByID(taskId);
  const { data: taskCategory, isLoading: isCategLoading } = useGetCategoryByID(
          ...
          <section>
            ...
            >
              ...
              {selectedTask?.completed ? (
                <p className={`capitalize w-50 green fw-bold space`}>
                  Completed
                </p>
              ) : (
                <p className={`capitalize w-50 red fw-bold space`}>
                  Incomplete
                </p>
              )}
            </div>
